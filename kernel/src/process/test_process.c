...
#include "../sys/timer/apic_timer.h"     // for apic_delay
#include "../sys/timer/pit_timer.h"      // for delay
#include "../sys/timer/tsc.h"            // for tsc_sleep
#include "../sys/timer/hpet_timer.h"     // for hpet_sleep
