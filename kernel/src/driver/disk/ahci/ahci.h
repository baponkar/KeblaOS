...
bool ahci_read(HBA_PORT_T* port, uint64_t lba, uint32_t count, uintptr_t phys_buf);
bool ahci_write(HBA_PORT_T* port, uint64_t lba, uint32_t count, uintptr_t phys_buf);
