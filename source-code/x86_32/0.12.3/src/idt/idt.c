...
void isr_install()
{
   ...
   idt_set_gate(  0, (uint32_t)isr0 , 0x08, 0x8E);  // selector = 0x08 = 1000, 32-bit Interrupt Gate => flags = 0x8E = 1000 1110, (p=1, dpl=0b00, gate type=0b1110)
   idt_set_gate(  1, (uint32_t)isr1 , 0x08, 0x8E);  // Keyboard
   ...
   idt_set_gate( 14, (uint32_t)isr14 , 0x08, 0x8E); // paging
   ...
   idt_set_gate(128, (uint32_t)isr128, 0x08, 0x8E); //System call Write
   idt_set_gate(177, (uint32_t)isr177, 0x08, 0x8E); //System call Read
