[![KeblaOS Badge](https://img.shields.io/badge/KeblaOS-0.7.2-maker?labelColor=red&color=blue)](https://gitlab.com/baponkar/kebla-os)
...
<p style="display: flex;flex-direction: column;color:skyblue;font-size: 1.5em;align-items: center;justify-content: center;"> 0.7.2</p>
