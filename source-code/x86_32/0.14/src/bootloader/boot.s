...
MBOOT_PAGE_ALIGN    equ 1<<0    ; Load kernel and modules on a page boundary 1
MBOOT_MEM_INFO      equ 1<<1    ; Provide your kernel with memory info = 10
MBOOT_FRAMEBUFFER_INFO equ 1 << 2   ; Framebuffer tag request for graphical mode change into 1 << 2 = 100
MBOOT_HEADER_FLAGS  equ MBOOT_PAGE_ALIGN + MBOOT_MEM_INFO + MBOOT_FRAMEBUFFER_INFO   ; VIDEO_MODE (4) + MEMORY_INFO (2) + PAGE_ALIGN (1)
