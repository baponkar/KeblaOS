...
void cls();
void cls_color( uint64_t color);    // Clear screen with a specific color

void set_pixel(size_t x, size_t y, uint64_t color); // Set a pixel at a specified (x, y) position with a color
