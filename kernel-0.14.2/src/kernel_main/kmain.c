...
void kmain(){
    ...
    test_ahci(sata_disk);    // Test AHCI controller
    ...
    fat32_read_root_dir();  // Read root directory
    test_file_operations(); // Test file operations
    if (!fat32_delete_file("testfile.txt")) {
